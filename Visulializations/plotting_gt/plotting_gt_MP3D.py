...
rgb_map_file = "D7G3Y4RVNrH_0_2_color.png"
depth_map_file = "D7G3Y4RVNrH_0_2_depth.npy"
disp_map_file = "D7G3Y4RVNrH_0_2_color.npy"
...
plot_image(1, depth_map, "Depth GT", True, cmap='jet', filename=os.path.join(output_dir, "Depth_GT_MP3D.png"))
plot_image(3, disp_map, "Disp GT", True, cmap='jet', filename=os.path.join(output_dir, "Disp_GT_MP3D.png"))
